...
- [ ] **Raman** (A₁g–E¹₂g 피크 간격) → 층수·결정성, 소자 간 일관성
...
1. **재료 분석 측정(§1)을 먼저** — 좋은 flake 스크리닝 겸, 가장 리드타임 김

2. 동시에 **PRC 노드(§6)** 를 최소 2개 소자에 — R1의 가장 무거운 지적(n≥2) 해결

3. 상온 PPC(§4) → triexp 피팅으로 바로 연결

4. 통계·표(§7) → 원고 반영(§8) → response letter